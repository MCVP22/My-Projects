...
public class App 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("The system stops if cumlative proportion exceeds 100%");
        ...
        if(sum > 100)
        {
            double cumlativeSum = 0.0;

            for (int j = 0; j < proportion.size() - 1; j++)
            {
                cumlativeSum += proportion.get(j);
            }
            proportion.set(proportion.size() - 1, 100.0 - cumlativeSum);
        }
