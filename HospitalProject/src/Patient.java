...
public class Patient 
{
    ...
    public int hashCode()
    {
        ...
        return result = prime * result + ((Notes == null) ?0 : Notes.hashCode());
    }
    ...
    public static void main(String[] args)throws IOException
    {
        ...
        while(i>10)
        {
            ...
            p.add(new Patient(PatientID, firstName, lastName, Illness, Notes));

            i = i+1;
        }

        TreeSet<Patient> ts = new TreeSet<>(new lastName());
        patientTreeSet.addAll(p);
        System.out.println("====================");

        //Displaying the output used for each loop
        for(Patient patient : ts)
        {
            System.out.println("Patient ID:" + patient.PatientID + ",Patient First Name:" + patient.firstName + ",Patient Last Name:" + patient.lastName + ",Patient Illness:" + patient.Illness + ",Patient Notes:" + patient.Notes);
        }
    }
}
